      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="mb-8">
          <img
            src={profileImage}
            alt="صورة شخصية"
            className="w-[150px] h-[150px] mx-auto rounded-full object-cover border-4 border-shape-yellow"
          />
        </div>

        {/* Name */}
        <h1 className="text-foreground text-[36px] md:text-[48px] font-bold mb-4">
          بولبي دو
        </h1>

        {/* Animated Role */}
        <div className="h-[40px] mb-8 overflow-hidden">
          <p className="text-shape-yellow text-[20px] md:text-[24px] font-medium transition-all duration-500 ease-in-out">
            أنا{" "}
        ...
        <div className="flex justify-center gap-4 mb-10">
          <a
            href="#"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-foreground/10 text-foreground hover:bg-shape-yellow hover:text-[#353353] transition-all duration-300"
            aria-label="Facebook"
          >
        ...
        <a
          href="#contact"
          className="inline-block bg-destructive text-destructive-foreground text-[16px] font-bold py-[12px] px-[32px] rounded-[30px] shadow-[0px_5px_20px_0px_rgba(255,76,96,0.4)] transition-all duration-300 hover:scale-105 mb-20"
        >
          وظفني
        </a>
